...
import static android.net.wifi.WifiInfo.SECURITY_TYPE_WAPI_PSK;
import static android.net.wifi.WifiInfo.SECURITY_TYPE_WAPI_CERT;
...
public class StandardWifiEntry extends WifiEntry {
    ...
    StandardWifiEntry(
        ...
        mIsWapiSupported = wifiManager.isWapiSupported();
        /* @} */
        ...
        if (mTargetSecurityTypes.size() == 1) {
            ...
            switch(security) {
                ...
                case SECURITY_TYPE_WAPI_PSK:
                    return mContext.getString(R.string.uniwifi_security_wapi_psk);
                case SECURITY_TYPE_WAPI_CERT:
                    return mContext.getString(R.string.uniwifi_security_wapi_cert);
                /* @} */
            }
        }
