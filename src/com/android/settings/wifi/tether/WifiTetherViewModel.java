...
public class WifiTetherViewModel extends AndroidViewModel {
    ...
    static {
        sSecuritySummaryResMap.put(SECURITY_TYPE_WPA3_SAE, com.android.settingslib.R.string.wifi_security_sae);
        sSecuritySummaryResMap.put(SECURITY_TYPE_WPA3_SAE_TRANSITION,
                com.android.settingslib.R.string.wifi_security_psk_sae);
        sSecuritySummaryResMap.put(SECURITY_TYPE_WPA2_PSK, com.android.settingslib.R.string.wifi_security_wpa2);
        sSecuritySummaryResMap.put(SECURITY_TYPE_OPEN, com.android.settingslib.R.string.wifi_security_none);
    }
