    ...
    private static void updateBatteryInfoCharging(Context context, Intent batteryBroadcast,
        ...
        if ((info.isBatteryDefender && status != BatteryManager.BATTERY_STATUS_FULL
            ...
            info.remainingLabel = chargeTimeMs <= 0 ? null : context.getString(
                    com.android.settingslib.R.string.power_remaining_charging_duration_only, timeString);
            ...
            info.chargeLabel = context.getString(com.android.settingslib.R.string.power_charging_future_paused,
            ...
            info.chargeLabel = info.batteryLevel == 100 ? info.batteryPercentString :
                    resources.getString(com.android.settingslib.R.string.power_charging, info.batteryPercentString,
                            chargeStatusLabel);
        }
    }
