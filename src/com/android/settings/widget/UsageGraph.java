...
public class UsageGraph extends View {
    ...
    public UsageGraph(Context context, @Nullable AttributeSet attrs) {
        ...
        mCornerRadius = resources.getDimensionPixelSize(com.android.settingslib.R.dimen.usage_graph_line_corner_radius);
        mLinePaint.setPathEffect(new CornerPathEffect(mCornerRadius));
        mLinePaint.setStrokeWidth(resources.getDimensionPixelSize(com.android.settingslib.R.dimen.usage_graph_line_width));
        ...
        float dots = resources.getDimensionPixelSize(com.android.settingslib.R.dimen.usage_graph_dot_size);
        float interval = resources.getDimensionPixelSize(com.android.settingslib.R.dimen.usage_graph_dot_interval);
        ...
        mDividerSize = resources.getDimensionPixelSize(com.android.settingslib.R.dimen.usage_graph_divider_size);
    }
