...
public class UserSettings extends SettingsPreferenceFragment
    ...
    private void updateGuestCategory(Context context, List<UserInfo> users) {
        ...
        for (UserInfo user : users) {
            ...
            pref.setEnabled(canOpenUserDetails);
            pref.setSelectable(true);
            Drawable icon = getContext().getDrawable(com.android.settingslib.R.drawable.ic_account_circle_outline);
            icon.setTint(
    ...
    private boolean updateAddGuestPreference(Context context, boolean isGuestAlreadyCreated) {
        ...
        if (!isGuestAlreadyCreated && mUserCaps.mCanAddGuest
            ...
            Drawable icon = context.getDrawable(com.android.settingslib.R.drawable.ic_account_circle);
    ...
    private void updateAddUser(Context context) {
        ...
        Drawable icon = context.getDrawable(com.android.settingslib.R.drawable.ic_account_circle_filled);
    ...
    private void updateAddSupervisedUser(Context context) {
        if (!TextUtils.isEmpty(mConfigSupervisedUserCreationPackage)) {
            ...
            Drawable icon = context.getDrawable(com.android.settingslib.R.drawable.ic_add_supervised_user);
