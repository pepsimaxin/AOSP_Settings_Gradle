...
public class BluetoothPairingDialogFragment extends InstrumentedDialogFragment implements
    ...
    private AlertDialog createConfirmationDialog() {
        ...
        mBuilder.setPositiveButton(getString(com.android.settingslib.R.string.bluetooth_pairing_accept), this);
        mBuilder.setNegativeButton(getString(com.android.settingslib.R.string.bluetooth_pairing_decline), this);
        AlertDialog dialog = mBuilder.create();
        return dialog;
    }
